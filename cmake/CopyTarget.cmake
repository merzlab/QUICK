...
function(remove_link_libraries TARGET) # ARGN: LIBRARIES...
	...
	if(NOT "${TARGET_LINK_LIBRARIES}" STREQUAL "")
		list(REMOVE_ITEM TARGET_LINK_LIBRARIES ${ARGN})
	endif()
	if(NOT "${TARGET_INTERFACE_LINK_LIBRARIES}" STREQUAL "")
...
function(remove_compile_definitions TARGET) # ARGN: LIBRARIES...
	get_property(TARGET_COMPILE_DEFINITIONS TARGET ${TARGET} PROPERTY COMPILE_DEFINITIONS)
	get_property(TARGET_INTERFACE_COMPILE_DEFINITIONS TARGET ${TARGET} PROPERTY INTERFACE_COMPILE_DEFINITIONS)
	
	if(NOT "${TARGET_COMPILE_DEFINITIONS}" STREQUAL "")
		list(REMOVE_ITEM TARGET_COMPILE_DEFINITIONS ${ARGN})
	endif()
	if(NOT "${TARGET_INTERFACE_COMPILE_DEFINITIONS}" STREQUAL "")
		list(REMOVE_ITEM TARGET_INTERFACE_COMPILE_DEFINITIONS ${ARGN})
	endif()
	
	set_property(TARGET ${TARGET} PROPERTY COMPILE_DEFINITIONS ${TARGET_COMPILE_DEFINITIONS})
	set_property(TARGET ${TARGET} PROPERTY INTERFACE_COMPILE_DEFINITIONS ${TARGET_INTERFACE_COMPILE_DEFINITIONS})
endfunction(remove_compile_definitions)