...
function(install_libraries) # LIBRARIES...
	cmake_parse_arguments(
			INSTALL_LIBS
			""
			"SUBDIR;COMPONENT;EXPORT"
			""
			${ARGN})
	
	if(NOT "${INSTALL_LIBS_COMPONENT}" STREQUAL "")
		set(COMPONENT_ARG COMPONENT ${INSTALL_LIBS_COMPONENT})
	endif()
	if(NOT "${INSTALL_LIBS_EXPORT}" STREQUAL "")
		set(EXPORT_ARG EXPORT ${INSTALL_LIBS_EXPORT})
	endif()

	printvar(INSTALL_LIBS_UNPARSED_ARGUMENTS)
