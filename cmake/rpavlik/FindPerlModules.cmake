...
# we build up a custom failure message as we go
set(FPM_FAILURE_MESSAGE "Failed to find Perl modules:")
	...
	foreach(module ${PerlModules_FIND_COMPONENTS})
		...
		if(NOT ${modvarname})
			...
			if(result_code EQUAL 0)
				...
				# to avoid spamming the log, only do this on the first run
				if(NOT DEFINED ${modvarname})
					file(APPEND
				...
				set(FPM_FAILURE_MESSAGE "${FPM_FAILURE_MESSAGE} ${module}")
			endif()
		endif()
	endforeach()
endif()
