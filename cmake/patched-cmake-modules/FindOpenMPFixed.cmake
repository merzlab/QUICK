...
foreach(LANG IN ITEMS C CXX Fortran)
	if(CMAKE_${LANG}_COMPILER_LOADED)
		...
		set(OpenMP_${LANG}_FIND_QUIETLY ${OpenMPFixed_FIND_QUIETLY})
		set(OpenMP_${LANG}_FIND_REQUIRED ${OpenMPFixed_FIND_REQUIRED})
		set(OpenMP_${LANG}_FIND_VERSION ${OpenMPFixed_FIND_VERSION})
		set(OpenMP_${LANG}_FIND_VERSION_EXACT ${OpenMPFixed_FIND_VERSION_EXACT})
