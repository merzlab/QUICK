...
aminstall: all
	...
	if [ -e $(buildfolder)/lib/serial/libblas.$(libsuffix) ]; then mv $(buildfolder)/lib/serial/libblas.$(libsuffix) $(installfolder)/lib/libblas-quick.$(libsuffix); fi; \
	...
	if [ -e $(buildfolder)/lib/mpi/libblas.$(libsuffix) ]; then mv $(buildfolder)/lib/mpi/libblas.$(libsuffix) $(installfolder)/lib/libblas-quick.$(libsuffix); fi; \
