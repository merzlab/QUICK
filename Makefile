...
aminstall: all
	...
	if [ -e $(buildfolder)/lib/serial/libblas.so ]; then mv $(buildfolder)/lib/serial/libblas.so $(installfolder)/lib/libblas-quick.so; fi; \
	...
	if [ -e $(buildfolder)/lib/mpi/libblas.so ]; then mv $(buildfolder)/lib/mpi/libblas.so $(installfolder)/lib/libblas-quick.so; fi; \
