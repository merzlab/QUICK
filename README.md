<p align="right">
 ...
 <img src='https://readthedocs.org/projects/quick-docs/badge/?version=26.3.0' alt='Documentation Status' />
</p>
<p align="left">
...
* [Installation Guide](https://quick-docs.readthedocs.io/en/26.3.0/installation-guide.html#installation-guide)
   1. [Compatible Compilers and Hardware](https://quick-docs.readthedocs.io/en/26.3.0/installation-guide.html#compatible-compilers-and-hardware)
   2. [Installation](https://quick-docs.readthedocs.io/en/26.3.0/installation-guide.html#installation)
   3. [Testing](https://quick-docs.readthedocs.io/en/26.3.0/installation-guide.html#environment-variables-and-testing)
   4. [Uninstallation](https://quick-docs.readthedocs.io/en/26.3.0/installation-guide.html#uninstallation-and-cleaning)

Getting Started
---------------
* [Hands-on Tutorials](https://quick-docs.readthedocs.io/en/26.3.0/hands-on-tutorials.html)
* [User Manual](https://quick-docs.readthedocs.io/en/26.3.0/user-manual.html)

Known Issues
------------
A list of installation and runtime issues can be found [here](https://quick-docs.readthedocs.io/en/26.3.0/known-issues.html#known-issues-of-current-version).
...
License
-------
QUICK is licensed under Mozilla Public License 2.0. More information can be found [here](https://quick-docs.readthedocs.io/en/26.3.0/license.html#mozilla-public-license-version-2-0).
