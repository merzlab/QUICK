...
! Schwartz cutoff for long range integrals is implemented here. 
! (ab|cd)**2<=(ab|ab)*(cd|cd)
! Reference: Strout DL and Scuseria JCP 102(1995),8448.

module quick_lri_cutoff_module
  implicit double precision(a-h,o-z)
  private
  ! public :: lri_density_cutoff
  ! public :: lri_dnscreen
  public :: lri_schwarzoff
...
subroutine lri_schwarzoff
  ...
  do II=1,nshell
     do JJ=II,nshell
        call lri_shellcutoff(II,JJ,Ymaxtemp)
...
end subroutine lri_schwarzoff

subroutine lri_shellcutoff(II,JJ,Ymax)
  use allmod
     ...
     do JJxiao=1,quick_basis%kprim(JJ)
        ...
        do I=NII1,NII2
           ...
           do J=NJJ1,NJJ2
              ...
              NNC=NNA
              NNCD=SumIndex(K+L)
              call lri_classprim(I,J,K,L,II,JJ,KK,LL,NNA,NNC,NNAB,NNCD,Ymaxprim,IIxiao,JJxiao)
           enddo
        enddo
  ...
  do I=NII1,NII2
     ...
     do J=NJJ1,NJJ2
        ...
        L=J
        NNCD=SumIndex(K+L)
        call lri_classcutoff(I,J,K,L,II,JJ,KK,LL,NNA,NNC,NNAB,NNCD,Ymax)
     enddo


  enddo

end subroutine lri_shellcutoff

subroutine lri_classcutoff(I,J,K,L,II,JJ,KK,LL,NNA,NNC,NNAB,NNCD,Ymax)
  use allmod
...
End subroutine lri_classcutoff

subroutine lri_classprim(I,J,K,L,II,JJ,KK,LL,NNA,NNC,NNAB,NNCD,Ymax1,IIIxiao,JJJxiao)
  use allmod
...
end module quick_lri_cutoff_module
