...
//  hipLaunchKernelGGL(getOEI_kernel, gpu->blocks, gpu->twoEThreadsPerBlock, 0, 0);

    hipLaunchKernelGGL(getOEI_kernel, 80, 256, 0, 0);
...
//  hipLaunchKernelGGL(getOEI_kernel, gpu->blocks, gpu->twoEThreadsPerBlock, 0, 0);
    ...
    hipLaunchKernelGGL(get_oei_grad_kernel, 80, 256, 0, 0);
