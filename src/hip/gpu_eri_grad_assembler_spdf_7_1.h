...
__device__ __inline__ void ERint_grad_vertical_spdf_7_1(const int I, const int J, const int K, const int L, const int II, const int JJ, const int KK, const int LL, 
