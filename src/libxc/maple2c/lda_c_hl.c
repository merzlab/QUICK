...
xc_lda_c_hl_func0_kernel(const void *p, xc_lda_work_t *r)   
#else   
static void   
...
#ifdef DEVICE   
__device__ static void   
xc_lda_c_hl_func1_kernel(const void *p, xc_lda_work_t *r)   
#else   
static void   
...
xc_lda_c_hl_func0_kernel(p, r);   
  else   
xc_lda_c_hl_func1_kernel(p, r);   
}   
#else   
void    
