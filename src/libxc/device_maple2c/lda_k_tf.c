...
xc_lda_k_tf_func0(const void *p, xc_lda_work_t *r)
#else
static void
...
#ifdef CUDA
__device__ static void
xc_lda_k_tf_func1(const void *p, xc_lda_work_t *r)
#else
static void
...
#ifdef CUDA
__device__ void
xc_lda_k_tf_func(const void *p, xc_lda_work_t *r)
{
  if(r->nspin == XC_UNPOLARIZED)
    xc_lda_k_tf_func0(p, r)
  else
    xc_lda_k_tf_func1(p, r)
}
#else
void 
