...
subroutine outputCopyright(io,ierr)
   ...
   write(io,'(A106)') " *********************************************************************************************************"
   write(io,'(A106)') " **                                                                                                     **"
   write(io,'(A106)') " **           888888888888                                                                              **"
   write(io,'(A106)') " **         8888888888888888                                                                            **"
   write(io,'(A106)') " **      888888888888888888                                                                             **"
   write(io,'(A106)') " **     888888888888888888                                                                              **"
   write(io,'(A106)') " **    888888888888888                                                                                  **"
   write(io,'(A106)') " **   88888888888888888888                               88888                       8888:              **"
   write(io,'(A106)') " **   8888888888888888888888Z                            88888                       8888:              **"
   write(io,'(A106)') " **   888888888888888888888888?                          88888                       8888:              **"
   write(io,'(A106)') " **   8888888888888      8888888                                        888888       8888:              **"
   write(io,'(A106)') " **    88888888888         888888     8888:     88888    88888        888888888I     8888:    888888    **"
   write(io,'(A106)') " **    8888888888           88888:    8888:     88888    88888      $888888888888    8888:   888888     **"
   ...
   write(io,'(A106)') " **            O888888888888888888     88888888888888    88888       88888888888$    8888:    888888    **"
   write(io,'(A106)') " **               8888888Z     888      .8888I  88888    88888         8888888       8888:     888888   **"
   write(io,'(A106)') " **                                                                                                     **"
   write(io,'(A106)') " **                                                                                                     **"
   write(io,'(A106)') " **                                         Copyright (c) 2020                                          **"
   write(io,'(A106)') " **                          Regents of the University of California San Diego                          **"
   write(io,'(A106)') " **                                    & Michigan State University                                      **"
   ...
   write(io,'(A106)') " Manathunga, M.; Mu, D.; Miao, Y.;He, X.; Ayers,K; Brothers, E.; Götz, A.; Merz,K. M. QUICK-20.03         "
   write(io,'(A106)') " University of California San Diego, CA and Michigan State University, East Lansing, MI, 2020             "
   write(io,'(A106)')
