...
!   else
       ...
       call gpu_upload_basis(nshell, nprim, jshell, jbasis, maxcontract, &
                             ...
                             quick_basis%Qnumber, quick_basis%Qstart, quick_basis%Qfinal, quick_basis%Qsbasis, &
                             quick_basis%Qfbasis, quick_basis%gccoeff, quick_basis%cons, &
                             quick_basis%gcexpo, quick_basis%KLMN)
