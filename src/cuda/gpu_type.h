...
struct gpu_calculated_type {
	...
	cuda_buffer_type<QUICKDouble>*  orbmp2j331; //first quarter of ERI transformation
	cuda_buffer_type<QUICKDouble>*  orbmp2k331; //first quarter of ERI transformation
