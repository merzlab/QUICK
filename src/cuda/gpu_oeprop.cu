...
#include "gpu_oeprop_classes.h"
#include "gpu_oeprop_definitions.h"
#include "gpu_oeprop_assembler.h"
#include "gpu_oeprop.h"
#include "gpu_oeprop_grad_assembler.h"
#include "gpu_oeprop_grad.h"
...
/*void get_oeprop_grad(_gpu_type gpu){

    QUICK_SAFE_CALL((get_oeprop_grad_kernel<<<gpu->blocks, gpu->twoEThreadsPerBlock>>>()));
