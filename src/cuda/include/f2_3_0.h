__device__ __inline__   void h2_3_0(QUICKDouble* YVerticalTemp, QUICKDouble* store,
                                   ...
                                   QUICKDouble CDtemp, QUICKDouble ABcom, QUICKDouble CDcom)
{
    ...
    LOC2(store, 10,  0, STOREDIM, STOREDIM) = f_3_0_0.x_10_0 ;
    LOC2(store, 11,  0, STOREDIM, STOREDIM) = f_3_0_0.x_11_0 ;
    LOC2(store, 12,  0, STOREDIM, STOREDIM) = f_3_0_0.x_12_0 ;
    LOC2(store, 13,  0, STOREDIM, STOREDIM) = f_3_0_0.x_13_0 ;
    LOC2(store, 14,  0, STOREDIM, STOREDIM) = f_3_0_0.x_14_0 ;
    LOC2(store, 15,  0, STOREDIM, STOREDIM) = f_3_0_0.x_15_0 ;
    LOC2(store, 16,  0, STOREDIM, STOREDIM) = f_3_0_0.x_16_0 ;
    LOC2(store, 17,  0, STOREDIM, STOREDIM) = f_3_0_0.x_17_0 ;
    LOC2(store, 18,  0, STOREDIM, STOREDIM) = f_3_0_0.x_18_0 ;
    LOC2(store, 19,  0, STOREDIM, STOREDIM) = f_3_0_0.x_19_0 ;
}
