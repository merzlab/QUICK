__device__ __inline__  void h2_0_6(QUICKDouble* YVerticalTemp, QUICKDouble* store,
                                   ...
                                   QUICKDouble CDtemp, QUICKDouble ABcom, QUICKDouble CDcom)
{
    ...
    LOCSTORE(store,  0, 56, STOREDIM, STOREDIM) = f_0_6_0.x_0_56 ;
    LOCSTORE(store,  0, 57, STOREDIM, STOREDIM) = f_0_6_0.x_0_57 ;
    LOCSTORE(store,  0, 58, STOREDIM, STOREDIM) = f_0_6_0.x_0_58 ;
    LOCSTORE(store,  0, 59, STOREDIM, STOREDIM) = f_0_6_0.x_0_59 ;
    LOCSTORE(store,  0, 60, STOREDIM, STOREDIM) = f_0_6_0.x_0_60 ;
    LOCSTORE(store,  0, 61, STOREDIM, STOREDIM) = f_0_6_0.x_0_61 ;
    LOCSTORE(store,  0, 62, STOREDIM, STOREDIM) = f_0_6_0.x_0_62 ;
    LOCSTORE(store,  0, 63, STOREDIM, STOREDIM) = f_0_6_0.x_0_63 ;
    LOCSTORE(store,  0, 64, STOREDIM, STOREDIM) = f_0_6_0.x_0_64 ;
    LOCSTORE(store,  0, 65, STOREDIM, STOREDIM) = f_0_6_0.x_0_65 ;
    LOCSTORE(store,  0, 66, STOREDIM, STOREDIM) = f_0_6_0.x_0_66 ;
    LOCSTORE(store,  0, 67, STOREDIM, STOREDIM) = f_0_6_0.x_0_67 ;
    LOCSTORE(store,  0, 68, STOREDIM, STOREDIM) = f_0_6_0.x_0_68 ;
    LOCSTORE(store,  0, 69, STOREDIM, STOREDIM) = f_0_6_0.x_0_69 ;
    LOCSTORE(store,  0, 70, STOREDIM, STOREDIM) = f_0_6_0.x_0_70 ;
    LOCSTORE(store,  0, 71, STOREDIM, STOREDIM) = f_0_6_0.x_0_71 ;
    LOCSTORE(store,  0, 72, STOREDIM, STOREDIM) = f_0_6_0.x_0_72 ;
    LOCSTORE(store,  0, 73, STOREDIM, STOREDIM) = f_0_6_0.x_0_73 ;
    LOCSTORE(store,  0, 74, STOREDIM, STOREDIM) = f_0_6_0.x_0_74 ;
    LOCSTORE(store,  0, 75, STOREDIM, STOREDIM) = f_0_6_0.x_0_75 ;
    LOCSTORE(store,  0, 76, STOREDIM, STOREDIM) = f_0_6_0.x_0_76 ;
    LOCSTORE(store,  0, 77, STOREDIM, STOREDIM) = f_0_6_0.x_0_77 ;
    LOCSTORE(store,  0, 78, STOREDIM, STOREDIM) = f_0_6_0.x_0_78 ;
    LOCSTORE(store,  0, 79, STOREDIM, STOREDIM) = f_0_6_0.x_0_79 ;
    LOCSTORE(store,  0, 80, STOREDIM, STOREDIM) = f_0_6_0.x_0_80 ;
    LOCSTORE(store,  0, 81, STOREDIM, STOREDIM) = f_0_6_0.x_0_81 ;
    LOCSTORE(store,  0, 82, STOREDIM, STOREDIM) = f_0_6_0.x_0_82 ;
    LOCSTORE(store,  0, 83, STOREDIM, STOREDIM) = f_0_6_0.x_0_83 ;
}
