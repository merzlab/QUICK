...
__device__ void addint_oeprop(unsigned int I, unsigned int J, unsigned int II, unsigned int JJ, unsigned int ipoint, QUICKDouble* store2){
...
__device__ void iclass_oeprop(unsigned int I, unsigned int J, unsigned int II, unsigned int JJ , unsigned int ipoint, unsigned int totalpoint, \
    unsigned int totalatom, QUICKDouble *YVerticalTemp, QUICKDouble *store, QUICKDouble *store2){
...
//            QUICKDouble YVerticalTemp[VDIM1*VDIM2*VDIM3];
            ...
            OEPROPnt_vertical(I, J, II, JJ, Px-Ax, Py-Ay, Pz-Az, Px-Bx, Py-By, Pz-Bz, Px-Cx, Py-Cy, Pz-Cz, 1/(2.0*Zeta), store, YVerticalTemp);
