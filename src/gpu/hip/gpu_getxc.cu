...
__device__ QUICKDouble SSW(QUICKDouble gridx, QUICKDouble gridy, QUICKDouble gridz,
...
__device__ void sswanader(const QUICKDouble gridx, const QUICKDouble gridy, const QUICKDouble gridz,
        const QUICKDouble Exc, const QUICKDouble quadwt, QUICKDouble* const smemGrad,
...
__device__ void pt2der_new(QUICKDouble gridx, QUICKDouble gridy, QUICKDouble gridz,
...
__device__ __forceinline__ QUICKDouble lyp_e(QUICKDouble pa, QUICKDouble pb,
...
/*
   ...
   ! w
*/
__device__ int gen_oh(int code, int num, QUICKDouble* x, QUICKDouble* y, QUICKDouble* z,
