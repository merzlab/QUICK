...
__device__ void addint_oei(unsigned int I, unsigned int J, unsigned int II, unsigned int JJ,
        unsigned int iatom, QUICKDouble* store2) {
...
__device__ void iclass_oei(unsigned int I, unsigned int J, unsigned int II, unsigned int JJ,
        unsigned int iatom, unsigned int totalatom, QUICKDouble *YVerticalTemp,
