__device__ __inline__  void h2_0_4(QUICKDouble* YVerticalTemp, QUICKDouble* store,
                                   ...
                                   QUICKDouble CDtemp, QUICKDouble ABcom, QUICKDouble CDcom)
{
    ...
    LOCSTORE(store,  0, 20, STOREDIM, STOREDIM) = f_0_4_0.x_0_20 ;
    LOCSTORE(store,  0, 21, STOREDIM, STOREDIM) = f_0_4_0.x_0_21 ;
    LOCSTORE(store,  0, 22, STOREDIM, STOREDIM) = f_0_4_0.x_0_22 ;
    LOCSTORE(store,  0, 23, STOREDIM, STOREDIM) = f_0_4_0.x_0_23 ;
    LOCSTORE(store,  0, 24, STOREDIM, STOREDIM) = f_0_4_0.x_0_24 ;
    LOCSTORE(store,  0, 25, STOREDIM, STOREDIM) = f_0_4_0.x_0_25 ;
    LOCSTORE(store,  0, 26, STOREDIM, STOREDIM) = f_0_4_0.x_0_26 ;
    LOCSTORE(store,  0, 27, STOREDIM, STOREDIM) = f_0_4_0.x_0_27 ;
    LOCSTORE(store,  0, 28, STOREDIM, STOREDIM) = f_0_4_0.x_0_28 ;
    LOCSTORE(store,  0, 29, STOREDIM, STOREDIM) = f_0_4_0.x_0_29 ;
    LOCSTORE(store,  0, 30, STOREDIM, STOREDIM) = f_0_4_0.x_0_30 ;
    LOCSTORE(store,  0, 31, STOREDIM, STOREDIM) = f_0_4_0.x_0_31 ;
    LOCSTORE(store,  0, 32, STOREDIM, STOREDIM) = f_0_4_0.x_0_32 ;
    LOCSTORE(store,  0, 33, STOREDIM, STOREDIM) = f_0_4_0.x_0_33 ;
    LOCSTORE(store,  0, 34, STOREDIM, STOREDIM) = f_0_4_0.x_0_34 ;
}
