                                   ...
                                   QUICKDouble CDtemp, QUICKDouble ABcom, QUICKDouble CDcom)
{
    ...
    LOCSTORE(store,  0,  1, STOREDIM, STOREDIM) += f_0_1_0.x_0_1 ;
    LOCSTORE(store,  0,  2, STOREDIM, STOREDIM) += f_0_1_0.x_0_2 ;
    LOCSTORE(store,  0,  3, STOREDIM, STOREDIM) += f_0_1_0.x_0_3 ;
}
