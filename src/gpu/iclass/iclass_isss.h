...

{
    ...
    LOCSTORE(store, 65, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_35_0_0 + WPtempx * x_35_0_1 + ABtemp * (x_22_0_0 - CDcom * x_22_0_1);
    ...
    LOCSTORE(store, 62, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_36_0_0 + WPtempx * x_36_0_1 + 2.000000 * ABtemp * (x_25_0_0 - CDcom * x_25_0_1);
    ...
    LOCSTORE(store, 64, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_37_0_0 + WPtempx * x_37_0_1 + 2.000000 * ABtemp * (x_24_0_0 - CDcom * x_24_0_1);
    ...
    LOCSTORE(store, 56, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_38_0_0 + WPtempx * x_38_0_1 + 3.000000 * ABtemp * (x_23_0_0 - CDcom * x_23_0_1);
    ...
    LOCSTORE(store, 63, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_39_0_0 + WPtempx * x_39_0_1 + ABtemp * (x_30_0_0 - CDcom * x_30_0_1);
    ...
    LOCSTORE(store, 61, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_40_0_0 + WPtempx * x_40_0_1 + ABtemp * (x_31_0_0 - CDcom * x_31_0_1);
    ...
    LOCSTORE(store, 78, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempy * x_41_0_0 + WPtempy * x_41_0_1 + 2.000000 * ABtemp * (x_31_0_0 - CDcom * x_31_0_1);
    LOCSTORE(store, 59, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_41_0_0 + WPtempx * x_41_0_1;
    ...
    LOCSTORE(store, 73, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempy * x_42_0_0 + WPtempy * x_42_0_1 + 3.000000 * ABtemp * (x_22_0_0 - CDcom * x_22_0_1);
    LOCSTORE(store, 60, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_42_0_0 + WPtempx * x_42_0_1;
    ...
    LOCSTORE(store, 79, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_43_0_0 + WPtempx * x_43_0_1 + 2.000000 * ABtemp * (x_27_0_0 - CDcom * x_27_0_1);
    ...
    LOCSTORE(store, 75, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_44_0_0 + WPtempx * x_44_0_1 + 3.000000 * ABtemp * (x_21_0_0 - CDcom * x_21_0_1);
    ...
    LOCSTORE(store, 80, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_45_0_0 + WPtempx * x_45_0_1 + 2.000000 * ABtemp * (x_29_0_0 - CDcom * x_29_0_1);
    ...
    LOCSTORE(store, 77, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_46_0_0 + WPtempx * x_46_0_1 + 3.000000 * ABtemp * (x_20_0_0 - CDcom * x_20_0_1);
    ...
    LOCSTORE(store, 72, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempy * x_47_0_0 + WPtempy * x_47_0_1 + ABtemp * (x_34_0_0 - CDcom * x_34_0_1);
    LOCSTORE(store, 58, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_47_0_0 + WPtempx * x_47_0_1;
    ...
    LOCSTORE(store, 67, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempy * x_48_0_0 + WPtempy * x_48_0_1 + 4.000000 * ABtemp * (x_30_0_0 - CDcom * x_30_0_1);
    LOCSTORE(store, 57, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_48_0_0 + WPtempx * x_48_0_1;
    QUICKDouble x_49_0_0 = Ptempx * x_34_0_0 + WPtempx * x_34_0_1;
    QUICKDouble x_49_0_1 = Ptempx * x_34_0_1 + WPtempx * x_34_0_2;
    LOCSTORE(store, 74, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_49_0_0 + WPtempx * x_49_0_1 + ABtemp * (x_34_0_0 - CDcom * x_34_0_1);
    ...
    LOCSTORE(store, 69, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_50_0_0 + WPtempx * x_50_0_1 + 4.000000 * ABtemp * (x_26_0_0 - CDcom * x_26_0_1);
    ...
    LOCSTORE(store, 76, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_51_0_0 + WPtempx * x_51_0_1 + ABtemp * (x_33_0_0 - CDcom * x_33_0_1);
    ...
    LOCSTORE(store, 71, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_52_0_0 + WPtempx * x_52_0_1 + 4.000000 * ABtemp * (x_28_0_0 - CDcom * x_28_0_1);
    ...
    LOCSTORE(store, 81, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_53_0_0 + WPtempx * x_53_0_1 + 5.000000 * ABtemp * (x_32_0_0 - CDcom * x_32_0_1);
    ...
    LOCSTORE(store, 82, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempy * x_54_0_0 + WPtempy * x_54_0_1 + 5.000000 * ABtemp * (x_33_0_0 - CDcom * x_33_0_1);
    LOCSTORE(store, 70, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_54_0_0 + WPtempx * x_54_0_1;
    ...
    LOCSTORE(store, 83, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempz * x_55_0_0 + WPtempz * x_55_0_1 + 5.000000 * ABtemp * (x_34_0_0 - CDcom * x_34_0_1);
    LOCSTORE(store, 68, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempx * x_55_0_0 + WPtempx * x_55_0_1;
    LOCSTORE(store, 66, 0, STOREDIM, STOREDIM) STORE_OPERATOR Ptempy * x_55_0_0 + WPtempy * x_55_0_1;
    // [IS|SS] integral - End 
