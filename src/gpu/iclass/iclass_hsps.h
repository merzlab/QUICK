...

{
    ...
    LOCSTORE(store, 35, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_35_0_0 + WQtempz * x_35_0_1 + 2.000000 * ABCDtemp * x_24_0_1;
    QUICKDouble x_25_0_1 = Ptempx * x_16_0_1 + WPtempx * x_16_0_2;
    LOCSTORE(store, 35, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_35_0_0 + WQtempy * x_35_0_1 + 2.000000 * ABCDtemp * x_25_0_1;
    LOCSTORE(store, 35, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_35_0_0 + WQtempx * x_35_0_1 + ABCDtemp * x_22_0_1;
    ...
    LOCSTORE(store, 36, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_36_0_0 + WQtempz * x_36_0_1 + 2.000000 * ABCDtemp * x_23_0_1;
    ...
    LOCSTORE(store, 36, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_36_0_0 + WQtempy * x_36_0_1 + ABCDtemp * x_21_0_1;
    LOCSTORE(store, 36, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_36_0_0 + WQtempx * x_36_0_1 + 2.000000 * ABCDtemp * x_25_0_1;
    ...
    LOCSTORE(store, 37, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_37_0_0 + WQtempz * x_37_0_1 + ABCDtemp * x_20_0_1;
    LOCSTORE(store, 37, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_37_0_0 + WQtempy * x_37_0_1 + 2.000000 * ABCDtemp * x_23_0_1;
    LOCSTORE(store, 37, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_37_0_0 + WQtempx * x_37_0_1 + 2.000000 * ABCDtemp * x_24_0_1;
    ...
    LOCSTORE(store, 38, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_38_0_0 + WQtempz * x_38_0_1 + ABCDtemp * x_28_0_1;
    ...
    LOCSTORE(store, 38, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_38_0_0 + WQtempy * x_38_0_1 + ABCDtemp * x_26_0_1;
    LOCSTORE(store, 38, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_38_0_0 + WQtempx * x_38_0_1 + 3.000000 * ABCDtemp * x_23_0_1;
    ...
    LOCSTORE(store, 39, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_39_0_0 + WQtempz * x_39_0_1 + ABCDtemp * x_29_0_1;
    LOCSTORE(store, 39, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_39_0_0 + WQtempy * x_39_0_1 + 3.000000 * ABCDtemp * x_24_0_1;
    LOCSTORE(store, 39, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_39_0_0 + WQtempx * x_39_0_1 + ABCDtemp * x_30_0_1;
    ...
    LOCSTORE(store, 40, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_40_0_0 + WQtempz * x_40_0_1 + 3.000000 * ABCDtemp * x_25_0_1;
    QUICKDouble x_27_0_1 = Ptempx * x_19_0_1 + WPtempx * x_19_0_2;
    LOCSTORE(store, 40, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_40_0_0 + WQtempy * x_40_0_1 + ABCDtemp * x_27_0_1;
    LOCSTORE(store, 40, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_40_0_0 + WQtempx * x_40_0_1 + ABCDtemp * x_31_0_1;
    ...
    LOCSTORE(store, 41, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_41_0_0 + WQtempz * x_41_0_1 + 3.000000 * ABCDtemp * x_22_0_1;
    LOCSTORE(store, 41, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_41_0_0 + WQtempy * x_41_0_1 + 2.000000 * ABCDtemp * x_31_0_1;
    LOCSTORE(store, 41, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_41_0_0 + WQtempx * x_41_0_1;
    ...
    LOCSTORE(store, 42, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_42_0_0 + WQtempz * x_42_0_1 + 2.000000 * ABCDtemp * x_30_0_1;
    LOCSTORE(store, 42, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_42_0_0 + WQtempy * x_42_0_1 + 3.000000 * ABCDtemp * x_22_0_1;
    LOCSTORE(store, 42, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_42_0_0 + WQtempx * x_42_0_1;
    ...
    LOCSTORE(store, 43, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_43_0_0 + WQtempz * x_43_0_1 + 3.000000 * ABCDtemp * x_21_0_1;
    LOCSTORE(store, 43, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_43_0_0 + WQtempy * x_43_0_1;
    LOCSTORE(store, 43, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_43_0_0 + WQtempx * x_43_0_1 + 2.000000 * ABCDtemp * x_27_0_1;
    ...
    LOCSTORE(store, 44, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_44_0_0 + WQtempz * x_44_0_1 + 2.000000 * ABCDtemp * x_26_0_1;
    LOCSTORE(store, 44, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_44_0_0 + WQtempy * x_44_0_1;
    LOCSTORE(store, 44, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_44_0_0 + WQtempx * x_44_0_1 + 3.000000 * ABCDtemp * x_21_0_1;
    ...
    LOCSTORE(store, 45, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_45_0_0 + WQtempz * x_45_0_1;
    LOCSTORE(store, 45, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_45_0_0 + WQtempy * x_45_0_1 + 3.000000 * ABCDtemp * x_20_0_1;
    LOCSTORE(store, 45, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_45_0_0 + WQtempx * x_45_0_1 + 2.000000 * ABCDtemp * x_29_0_1;
    ...
    LOCSTORE(store, 46, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_46_0_0 + WQtempz * x_46_0_1;
    LOCSTORE(store, 46, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_46_0_0 + WQtempy * x_46_0_1 + 2.000000 * ABCDtemp * x_28_0_1;
    LOCSTORE(store, 46, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_46_0_0 + WQtempx * x_46_0_1 + 3.000000 * ABCDtemp * x_20_0_1;
    ...
    LOCSTORE(store, 47, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_47_0_0 + WQtempz * x_47_0_1 + 4.000000 * ABCDtemp * x_31_0_1;
    LOCSTORE(store, 47, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_47_0_0 + WQtempy * x_47_0_1 + ABCDtemp * x_34_0_1;
    LOCSTORE(store, 47, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_47_0_0 + WQtempx * x_47_0_1;
    ...
    LOCSTORE(store, 48, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_48_0_0 + WQtempz * x_48_0_1 + ABCDtemp * x_33_0_1;
    LOCSTORE(store, 48, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_48_0_0 + WQtempy * x_48_0_1 + 4.000000 * ABCDtemp * x_30_0_1;
    LOCSTORE(store, 48, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_48_0_0 + WQtempx * x_48_0_1;
    QUICKDouble x_49_0_0 = Ptempx * x_34_0_0 + WPtempx * x_34_0_1;
    QUICKDouble x_49_0_1 = Ptempx * x_34_0_1 + WPtempx * x_34_0_2;
    LOCSTORE(store, 49, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_49_0_0 + WQtempz * x_49_0_1 + 4.000000 * ABCDtemp * x_27_0_1;
    LOCSTORE(store, 49, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_49_0_0 + WQtempy * x_49_0_1;
    LOCSTORE(store, 49, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_49_0_0 + WQtempx * x_49_0_1 + ABCDtemp * x_34_0_1;
    ...
    LOCSTORE(store, 50, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_50_0_0 + WQtempz * x_50_0_1 + ABCDtemp * x_32_0_1;
    LOCSTORE(store, 50, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_50_0_0 + WQtempy * x_50_0_1;
    LOCSTORE(store, 50, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_50_0_0 + WQtempx * x_50_0_1 + 4.000000 * ABCDtemp * x_26_0_1;
    ...
    LOCSTORE(store, 51, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_51_0_0 + WQtempz * x_51_0_1;
    LOCSTORE(store, 51, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_51_0_0 + WQtempy * x_51_0_1 + 4.000000 * ABCDtemp * x_29_0_1;
    LOCSTORE(store, 51, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_51_0_0 + WQtempx * x_51_0_1 + ABCDtemp * x_33_0_1;
    ...
    LOCSTORE(store, 52, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_52_0_0 + WQtempz * x_52_0_1;
    LOCSTORE(store, 52, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_52_0_0 + WQtempy * x_52_0_1 + ABCDtemp * x_32_0_1;
    LOCSTORE(store, 52, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_52_0_0 + WQtempx * x_52_0_1 + 4.000000 * ABCDtemp * x_28_0_1;
    ...
    LOCSTORE(store, 53, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_53_0_0 + WQtempz * x_53_0_1;
    LOCSTORE(store, 53, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_53_0_0 + WQtempy * x_53_0_1;
    LOCSTORE(store, 53, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_53_0_0 + WQtempx * x_53_0_1 + 5.000000 * ABCDtemp * x_32_0_1;
    ...
    LOCSTORE(store, 54, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_54_0_0 + WQtempz * x_54_0_1;
    LOCSTORE(store, 54, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_54_0_0 + WQtempy * x_54_0_1 + 5.000000 * ABCDtemp * x_33_0_1;
    LOCSTORE(store, 54, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_54_0_0 + WQtempx * x_54_0_1;
    ...
    LOCSTORE(store, 55, 3, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_55_0_0 + WQtempz * x_55_0_1 + 5.000000 * ABCDtemp * x_34_0_1;
    LOCSTORE(store, 55, 2, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_55_0_0 + WQtempy * x_55_0_1;
    LOCSTORE(store, 55, 1, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_55_0_0 + WQtempx * x_55_0_1;
    // [HS|PS] integral - End 
