...

{
    ...
    LOCSTORE(store, 40, 7, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_40_1_0 + WQtempx * x_40_1_1 + CDtemp * (x_40_0_0 - ABcom * x_40_0_1) + ABCDtemp * x_31_1_1;
    ...
    LOCSTORE(store, 41, 7, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_41_1_0 + WQtempx * x_41_1_1 + CDtemp * (x_41_0_0 - ABcom * x_41_0_1);
    ...
    LOCSTORE(store, 41, 4, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_41_2_0 + WQtempx * x_41_2_1;
    ...
    LOCSTORE(store, 47, 7, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_47_1_0 + WQtempx * x_47_1_1 + CDtemp * (x_47_0_0 - ABcom * x_47_0_1);
    ...
    LOCSTORE(store, 47, 8, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_47_2_0 + WQtempy * x_47_2_1 + CDtemp * (x_47_0_0 - ABcom * x_47_0_1) + ABCDtemp * x_34_2_1;
    LOCSTORE(store, 47, 4, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_47_2_0 + WQtempx * x_47_2_1;
    ...
    LOCSTORE(store, 47, 6, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_47_3_0 + WQtempx * x_47_3_1;
    ...
    LOCSTORE(store, 49, 7, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_49_1_0 + WQtempx * x_49_1_1 + CDtemp * (x_49_0_0 - ABcom * x_49_0_1) + ABCDtemp * x_34_1_1;
    QUICKDouble x_49_2_0 = Qtempy * x_49_0_0 + WQtempy * x_49_0_1;
    QUICKDouble x_49_2_1 = Qtempy * x_49_0_1 + WQtempy * x_49_0_2;
    LOCSTORE(store, 49, 8, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_49_2_0 + WQtempy * x_49_2_1 + CDtemp * (x_49_0_0 - ABcom * x_49_0_1);
    LOCSTORE(store, 49, 4, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_49_2_0 + WQtempx * x_49_2_1 + ABCDtemp * x_34_2_1;
    ...
    LOCSTORE(store, 55, 7, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_55_1_0 + WQtempx * x_55_1_1 + CDtemp * (x_55_0_0 - ABcom * x_55_0_1);
    QUICKDouble x_55_2_0 = Qtempy * x_55_0_0 + WQtempy * x_55_0_1;
    QUICKDouble x_55_2_1 = Qtempy * x_55_0_1 + WQtempy * x_55_0_2;
    LOCSTORE(store, 55, 8, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_55_2_0 + WQtempy * x_55_2_1 + CDtemp * (x_55_0_0 - ABcom * x_55_0_1);
    LOCSTORE(store, 55, 4, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_55_2_0 + WQtempx * x_55_2_1;
    ...
    LOCSTORE(store, 55, 6, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_55_3_0 + WQtempx * x_55_3_1;
    LOCSTORE(store, 55, 5, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_55_3_0 + WQtempy * x_55_3_1;
    // [HS|DS] integral - End 
