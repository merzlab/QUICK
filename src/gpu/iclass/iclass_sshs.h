...

{
    ...
    LOCSTORE(store, 0, 46, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_20_0 + WQtempx * x_0_20_1 + 2.000000 * CDtemp * (x_0_12_0 - ABcom * x_0_12_1);
    ...
    LOCSTORE(store, 0, 44, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_21_0 + WQtempx * x_0_21_1 + 2.000000 * CDtemp * (x_0_14_0 - ABcom * x_0_14_1);
    ...
    LOCSTORE(store, 0, 42, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_0_22_0 + WQtempy * x_0_22_1 + 2.000000 * CDtemp * (x_0_16_0 - ABcom * x_0_16_1);
    LOCSTORE(store, 0, 35, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_22_0 + WQtempx * x_0_22_1;
    ...
    LOCSTORE(store, 0, 38, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_23_0 + WQtempx * x_0_23_1 + 2.000000 * CDtemp * (x_0_10_0 - ABcom * x_0_10_1);
    ...
    LOCSTORE(store, 0, 37, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_24_0 + WQtempx * x_0_24_1 + CDtemp * (x_0_15_0 - ABcom * x_0_15_1);
    QUICKDouble x_0_25_0 = Qtempx * x_0_16_0 + WQtempx * x_0_16_1;
    QUICKDouble x_0_25_1 = Qtempx * x_0_16_1 + WQtempx * x_0_16_2;
    LOCSTORE(store, 0, 36, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_25_0 + WQtempx * x_0_25_1 + CDtemp * (x_0_16_0 - ABcom * x_0_16_1);
    ...
    LOCSTORE(store, 0, 50, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_26_0 + WQtempx * x_0_26_1 + 3.000000 * CDtemp * (x_0_13_0 - ABcom * x_0_13_1);
    ...
    LOCSTORE(store, 0, 43, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_27_0 + WQtempx * x_0_27_1 + CDtemp * (x_0_19_0 - ABcom * x_0_19_1);
    ...
    LOCSTORE(store, 0, 52, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_28_0 + WQtempx * x_0_28_1 + 3.000000 * CDtemp * (x_0_11_0 - ABcom * x_0_11_1);
    ...
    LOCSTORE(store, 0, 45, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_29_0 + WQtempx * x_0_29_1 + CDtemp * (x_0_18_0 - ABcom * x_0_18_1);
    ...
    LOCSTORE(store, 0, 48, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_0_30_0 + WQtempy * x_0_30_1 + 3.000000 * CDtemp * (x_0_15_0 - ABcom * x_0_15_1);
    LOCSTORE(store, 0, 39, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_30_0 + WQtempx * x_0_30_1;
    QUICKDouble x_0_31_0 = Qtempy * x_0_19_0 + WQtempy * x_0_19_1;
    QUICKDouble x_0_31_1 = Qtempy * x_0_19_1 + WQtempy * x_0_19_2;
    LOCSTORE(store, 0, 41, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_0_31_0 + WQtempy * x_0_31_1 + CDtemp * (x_0_19_0 - ABcom * x_0_19_1);
    LOCSTORE(store, 0, 40, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_31_0 + WQtempx * x_0_31_1;
    ...
    LOCSTORE(store, 0, 53, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_32_0 + WQtempx * x_0_32_1 + 4.000000 * CDtemp * (x_0_17_0 - ABcom * x_0_17_1);
    ...
    LOCSTORE(store, 0, 54, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_0_33_0 + WQtempy * x_0_33_1 + 4.000000 * CDtemp * (x_0_18_0 - ABcom * x_0_18_1);
    LOCSTORE(store, 0, 51, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_33_0 + WQtempx * x_0_33_1;
    ...
    LOCSTORE(store, 0, 55, STOREDIM, STOREDIM) STORE_OPERATOR Qtempz * x_0_34_0 + WQtempz * x_0_34_1 + 4.000000 * CDtemp * (x_0_19_0 - ABcom * x_0_19_1);
    LOCSTORE(store, 0, 49, STOREDIM, STOREDIM) STORE_OPERATOR Qtempx * x_0_34_0 + WQtempx * x_0_34_1;
    LOCSTORE(store, 0, 47, STOREDIM, STOREDIM) STORE_OPERATOR Qtempy * x_0_34_0 + WQtempy * x_0_34_1;
    // [SS|HS] integral - End 
