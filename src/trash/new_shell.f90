...
subroutine iclass(I,J,K,L,NNA,NNC,NNAB,NNCD)
   ...
   !Madu: Set the level of HF exhange 
            ...
            do JJJ=JJJ1,JJJ2
               do KKK=KKK1,KKK2
                  do LLL=LLL1,LLL2
                     ...
                     quick_qm_struct%o(JJJ,III) = quick_qm_struct%o(JJJ,III)+2.d0*DENSELK*Y
                     quick_qm_struct%o(LLL,KKK) = quick_qm_struct%o(LLL,KKK)+2.d0*DENSEJI*Y
                     quick_qm_struct%o(KKK,III) = quick_qm_struct%o(KKK,III)-hybrid_coeff*.5d0*DENSELJ*Y
                     quick_qm_struct%o(LLL,III) = quick_qm_struct%o(LLL,III)-hybrid_coeff*.5d0*DENSEKJ*Y
                     quick_qm_struct%o(JJJ,KKK) = quick_qm_struct%o(JJJ,KKK)-hybrid_coeff*.5d0*DENSELI*Y
                     quick_qm_struct%o(JJJ,LLL) = quick_qm_struct%o(JJJ,LLL)-hybrid_coeff*.5d0*DENSEKI*Y
                     quick_qm_struct%o(KKK,JJJ) = quick_qm_struct%o(KKK,JJJ)-hybrid_coeff*.5d0*DENSELI*Y
                     quick_qm_struct%o(LLL,JJJ) = quick_qm_struct%o(LLL,JJJ)-hybrid_coeff*.5d0*DENSEKI*Y
...
!--------------------Madu--------------------------
                           ...
                           quick_qm_struct%o(III,III) = quick_qm_struct%o(III,III)+DENSEJJ*Y
                           quick_qm_struct%o(KKK,KKK) = quick_qm_struct%o(KKK,KKK)+DENSEII*Y
                           quick_qm_struct%o(KKK,III) = quick_qm_struct%o(KKK,III)-hybrid_coeff*.5d0*DENSEJI*Y
...
!--------------------Madu--------------------------
                           ...
                           ! Find  all the (ij|jj) integrals.
                           quick_qm_struct%o(JJJ,III) = quick_qm_struct%o(JJJ,III)+DENSEJJ*Y-hybrid_coeff*.5d0*DENSEJJ*Y
                           quick_qm_struct%o(JJJ,JJJ) = quick_qm_struct%o(JJJ,JJJ)+2.0d0*DENSEJI*Y-hybrid_coeff*DENSEJI*Y 
                           !        ! Find  all the (ii|ij) integrals.
                           !        ! Find all the (ij|ij) integrals
...
!--------------------Madu--------------------------
                           ...
                           quick_qm_struct%o(JJJ,III) = quick_qm_struct%o(JJJ,III)+DENSEKK*Y
                           quick_qm_struct%o(KKK,KKK) = quick_qm_struct%o(KKK,KKK)+2.d0*DENSEJI*Y
                           quick_qm_struct%o(KKK,III) = quick_qm_struct%o(KKK,III)-hybrid_coeff*.5d0*DENSEKJ*Y
                           quick_qm_struct%o(KKK,JJJ) = quick_qm_struct%o(KKK,JJJ)-hybrid_coeff*.5d0*DENSEKI*Y
                           quick_qm_struct%o(JJJ,KKK) = quick_qm_struct%o(JJJ,KKK)-hybrid_coeff*.5d0*DENSEKI*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = true"
...
!--------------------Madu--------------------------
                           ...
                           quick_qm_struct%o(LLL,KKK) = quick_qm_struct%o(LLL,KKK)+DENSEII*Y
                           quick_qm_struct%o(III,III) = quick_qm_struct%o(III,III)+2.d0*DENSEKJ*Y
                           quick_qm_struct%o(KKK,III) = quick_qm_struct%o(KKK,III)-hybrid_coeff*.5d0*DENSEKI*Y
                           quick_qm_struct%o(LLL,III) = quick_qm_struct%o(LLL,III)-hybrid_coeff*.5d0*DENSEJI*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = true"
!write(*,*) "III<JJJ and KKK<LLL"
!  write(*,'(A52,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3)')&
...
!--------------------Madu--------------------------
                        ...
                        if(JJJ.LE.LLL)then
                           ...
                           if(III.eq.JJJ.and.III.eq.KKK.and.III.eq.LLL)then
                              ...
                              ! do all the (ii|ii) integrals.
                              quick_qm_struct%o(III,III) = quick_qm_struct%o(III,III)+DENSEII*Y-hybrid_coeff*.5d0*DENSEII*Y
!--------------------Madu---------------------------
...
!--------------------Madu--------------------------
                              ...
                              ! Find  all the (ii|ij) integrals.
                              quick_qm_struct%o(LLL,III) = quick_qm_struct%o(LLL,III)+DENSEII*Y-hybrid_coeff*.5d0*DENSEII*Y
                              quick_qm_struct%o(III,III) = quick_qm_struct%o(III,III)+2.0d0*DENSEJI*Y-hybrid_coeff*DENSEJI*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = false, JJJ<LLL=true"
!write(*,*) "III==JJJ and III==KKK and III<LLL"
!  write(*,'(A52,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3,1x,I3)')&
...
!--------------------Madu--------------------------
                              ...
                              ! Find all the (ij|ij) integrals
                              quick_qm_struct%o(JJJ,III) = quick_qm_struct%o(JJJ,III)+2.0d0*DENSEJI*Y-hybrid_coeff*0.5d0*DENSEJI*Y
                              quick_qm_struct%o(JJJ,JJJ) = quick_qm_struct%o(JJJ,JJJ)-hybrid_coeff*.5d0*DENSEII*Y
                              quick_qm_struct%o(III,III) = quick_qm_struct%o(III,III)-hybrid_coeff*.5d0*DENSEJJ*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = false, JJJ<LLL=true"
...
!--------------------Madu--------------------------
                              ...
                              ! Find all the (ij|ik) integrals where j>i,k>j
                              quick_qm_struct%o(JJJ,III) = quick_qm_struct%o(JJJ,III)+2.0d0*DENSEKI*Y-hybrid_coeff*0.5d0*DENSEKI*Y
                              quick_qm_struct%o(LLL,III) = quick_qm_struct%o(LLL,III)+2.0d0*DENSEJI*Y-hybrid_coeff*0.5d0*DENSEJI*Y
                              quick_qm_struct%o(III,III) = quick_qm_struct%o(III,III)-hybrid_coeff*1.d0*DENSEKJ*Y
                              quick_qm_struct%o(LLL,JJJ) = quick_qm_struct%o(LLL,JJJ)-hybrid_coeff*.5d0*DENSEII*Y
!--------------------Madu---------------------------
!write(*,*) "II<JJ and II < KK and KK<LL = false, III<KKK = false, JJJ<LLL=true"
         ...
         do JJJ=JJJ1,JJJ2
            do KKK=KKK1,KKK2
               do LLL=LLL1,LLL2
                  ...
                  constant = (4.d0*DENSEJI*DENSELK-hybrid_coeff*DENSEKI*DENSELJ &
                        -hybrid_coeff*DENSELI*DENSEKJ)
...
!  II, JJ, KK, LL, III,JJJ,KKK,LLL
                        ...
                        constant = (DENSEII*DENSEJJ-.5d0*hybrid_coeff*DENSEJI*DENSEJI)
                        ...
                        constant = 2.0d0*DENSEJJ*DENSEJI-hybrid_coeff*DENSEJJ*DENSEJI
                       ...
                       constant=(2.d0*DENSEJI*DENSEKK-hybrid_coeff*DENSEKI*DENSEKJ)
...
!  II, JJ, KK, LL, III,JJJ,KKK,LLL
                        ...
                        constant = (2.d0*DENSEKJ*DENSEII-hybrid_coeff*DENSEJI*DENSEKI)
                     ...
                     if(JJJ.LE.LLL)then
                        ...
                        if(III.eq.JJJ.and.III.eq.KKK.and.III.eq.LLL)then
                           ...
                           constant = 2.0d0*DENSEJI*DENSEII-hybrid_coeff*DENSEJI*DENSEII
                           ...
                           constant =(2.0d0*DENSEJI*DENSEJI-0.5d0*hybrid_coeff*DENSEJI*DENSEJI &
                           -0.50d0*hybrid_coeff*DENSEJJ*DENSEII)
 ...
 ! II, JJ, KK, LL, III,JJJ,KKK,LLL
                           ...
                           constant = (4.0d0*DENSEJI*DENSEKI-hybrid_coeff*DENSEJI*DENSEKI &
                           -hybrid_coeff*DENSEKJ*DENSEII)
