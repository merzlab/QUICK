...
!              call shelloptdft
              ...
              !call shellb3lypopt(IIxiao,JJxiao,KKxiao,LLxiao)
              call shellopt
...
!!!!!!!!!!!!!!!!!!!!!!!Madu!!!!!!!!!!!!!!!!!!!!!!
                                !Exc=Ex+Ec
!write(*,*) "gridx,gridy,gridz,Eelxc,weight/sswt,Iatm",gridx,gridy,gridz,Eelxc,weight/sswt,Iatm
